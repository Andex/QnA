...
questions << Question.create([
             ...
             { title: 'Error occurred while installing mini_racer', body: 'Gem::Ext::BuildError: ERROR: Failed to build gem native extension.', user: users.sample },
])
...
3.times do
  answers << Answer.create([
             { body: Faker::Book, question: Question.first, user: users.sample },
             { body: Faker::Movie, question: Question.second, user: users.sample },
